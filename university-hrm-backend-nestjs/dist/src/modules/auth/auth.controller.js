...
let AuthController = class AuthController {
    ...
    async login(dto, req, res) {
        const result = await this.authService.login(dto.email, dto.password, dto.rememberMe || false, req.headers['user-agent'], req.ip);
    ...
    async logout(req, res, userId) {
        const refreshToken = req.cookies?.refreshToken;
        await this.authService.logout(refreshToken, userId, req.headers['user-agent'], req.ip);
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 429, description: 'Account locked or rate limited' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get active sessions for current user' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('sub')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
